...
start_data <- "original_data_ePRS_44s_uns_20250130.rdata"
...
plot7 <-  ggplot(ss_data@meta.data,
                  aes(color=ss_data@meta.data$Sample_ID,
                      x=nCount_RNA,
...
if (downsample) {
  ...
  ss_data_filtered <- subset(ss_data_filtered,
                       ident = unique(ss_data_filtered@meta.data[["Sample_ID"]]),
