...
start_data <- "QCd_louvain_multi_clustered_harmony_ws_32pcs_harm_44s_uns_20250130_rm813_13to16_2627_ADNC23_ws.rdata"
...
change_csv <- "ePRS_23samples_ADNC23_unsorted_metadata_20250710.csv"
...
remove <- NULL #c("1", "5", "10", "11", "13", "14", "16", "17")
...
combined <- #c("0", "3") # Oligos
  ...
  #c("1", "9", "10", "11", "12", "13", "15", "18", "21", "24") #Exc.Neurons
  #c("6", "7", "8", "14") # Inh.Neurons

# Rdata ouput name - add an identifier to your rdata file for ease of reuse
rdata_out_ident <- "ePRS_ADNC23_23samples_20260106_layer23"
...
if (!is.null(remove)) {
  ss_data_norm_subset <- subset(ss_data_norm_subset, idents = remove, invert = TRUE)
