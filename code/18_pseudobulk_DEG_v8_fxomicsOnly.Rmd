...
start_data <- "QCd_louvain_multi_clustered_harmony_ws_34pcsharm_23s_uns_ADNChigh_rm_8_14.rdata"
...
change_csv <- "ePRS_uns_23samples_ADNC_metadata_20231212.csv"
...
meta_vars <- c("ePRS", "sex", "APOE4_status")
...
remove <- c("1", "5", "10", "11", "13", "14", "16", "17")
...
combined <- NULL #c(0:16)

# Rdata ouput name - add an identifier to your rdata file for ease of reuse
rdata_out_ident <- "ePRS_representative_clusters_updatepathways"
...
## *** Added to avoid removing the APOE4_status variable since it isn't in the metadata
to_remove[3] <- FALSE
