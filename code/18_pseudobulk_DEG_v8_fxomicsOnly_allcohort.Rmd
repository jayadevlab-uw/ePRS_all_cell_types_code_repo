...
start_data <- "QCd_norm_harmony_ws_harm_36s_uns_20250130_rm813_13to16_2627_allADNC.rdata"
...
change_csv <- "ePRS_36samples_allADNC_highlow_metadata_20251203.csv"
...
meta_vars <- c("ePRS_category", "sex", "APOE4_status")
...
rdata_out_ident <- "ePRS_allADNC_36samples_20260112"
...
if (!is.null(remove)) {
  ss_data_norm <- subset(ss_data_norm, idents = remove, invert = TRUE)
